/*
  ...
  - The values [travel,house,relationship,celebration,others] on the enum `Category` will be removed. If these variants are still used in the database, this will fail.
