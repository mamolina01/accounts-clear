...
export const CostItem = ({ cost }: { cost: any }) => {
  ...
  return (
    <div
      className="bg-secondary w-full p-3 rounded grid grid-cols-[auto_1fr_1fr] gap-y-1 gap-x-2 hover:opacity-80 cursor-pointer animate__animated animate__fadeIn"
      onClick={toggleShowMore}
    >
      <BsChevronDown className={`${showMore && 'rotate-180'} transition-all self-center`} />
      <div>
